...
const Sidebar = ({ isSidebarOpen, setIsSidebarOpen, handleLogout }) => {
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static w-64 bg-white shadow-md min-h-screen lg:h-[calc(100vh-4rem)] transform transition-transform duration-300 z-50 ${
      ...
      >
        <nav className="p-4 flex flex-col h-full relative">
          ...
          {/* Logout button - Now positioned at the bottom with padding */}
          <div className="lg:hidden sticky bottom-0 left-0 right-0 bg-white pt-4 pb-4 border-t mt-4">
            <button
